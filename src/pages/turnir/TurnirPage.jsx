...
const TurnirPage = () => {
  return (
      ...
      <div className='grid grid-cols-3 gap-5'>
          ...
          <TurnirCard url={'/public/img/5.jpg'} title={"Netus hendrerit tortor laoreet duis proin nulla faucibus ultricies. Et urna fringilla nunc, metus nec. "} desc={"22 июля 2022 года" } />
          <TurnirCard url={'/public/img/6.jpg'} title={"Libero fermentum pretium sed orci nunc, sagittis mollis lacus dolor. Tincidunt et enim sed ac faucibus."} desc={ "22 июля 2022 года"} />
         </div>
         </div>
  )
}
